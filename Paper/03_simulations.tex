...
To assess whether the same users are influential across all three interaction
types, see Figure~\ref{fig:comparison} (right).

\subsection{Enron Email Network}

Figure~\ref{fig:enron_centrality} shows the top-15 Enron nodes by each
centrality metric.
% TODO: Interpret which email addresses correspond to which executives,
%       and discuss what betweenness/eigenvector reveal about org structure.
...
Figure~\ref{fig:fb_deg} and Figure~\ref{fig:fb_comm} show the degree
distribution and Louvain community structure of the Facebook network.
% TODO: Discuss what the 16 communities correspond to (ego circles),
%       and compare the community size distribution to Enron/Higgs.
